...
- **bigquery-driver:** Error with Cube.js pre-aggregations in BigQuery ([01815a1](https://github.com/statsbotco/cubejs-client/commit/01815a1)), closes [#158](https://github.com/statsbotco/cubejs-client/issues/158)

## [0.10.12](https://github.com/statsbotco/cubejs-client/compare/v0.10.11...v0.10.12) (2019-07-06)

### Bug Fixes

- Empty array for BigQuery in serverless GCP deployment ([#155](https://github.com/statsbotco/cubejs-client/issues/155)) ([045094c](https://github.com/statsbotco/cubejs-client/commit/045094c)), closes [#153](https://github.com/statsbotco/cubejs-client/issues/153)
