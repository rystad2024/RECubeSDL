...
- **@cubejs-backend/server:** Implement dev-server & server command ([#1227](https://github.com/statsbotco/cubejs-client/issues/1227)) ([84c1eeb](https://github.com/statsbotco/cubejs-client/commit/84c1eeb))
