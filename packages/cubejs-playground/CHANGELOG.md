...
## [0.11.4](https://github.com/statsbotco/cubejs-client/compare/v0.11.3...v0.11.4) (2019-10-16)

### Bug Fixes

- Remove legacy scaffolding comments ([123a929](https://github.com/statsbotco/cubejs-client/commit/123a929))
...
- **playground:** Rename Explore to Build ([ce067a9](https://github.com/statsbotco/cubejs-client/commit/ce067a9))
- **playground:** Show empty dashboard note ([ef559e5](https://github.com/statsbotco/cubejs-client/commit/ef559e5))
- **playground:** Support various chart libraries for dashboard generation ([a4ba9c5](https://github.com/statsbotco/cubejs-client/commit/a4ba9c5))
...
- **playground:** Copy code to clipboard ([30a2528](https://github.com/statsbotco/cubejs-client/commit/30a2528))
...
- **playground:** Go to explore modal after schema generation ([5325c2d](https://github.com/statsbotco/cubejs-client/commit/5325c2d))

## [0.9.14](https://github.com/statsbotco/cubejs-client/compare/v0.9.13...v0.9.14) (2019-06-07)

### Features

- View Query SQL in Playground ([8ef28c8](https://github.com/statsbotco/cubejs-client/commit/8ef28c8))
...
- **playground:** better add to dashboard error messages ([94e8dbf](https://github.com/statsbotco/cubejs-client/commit/94e8dbf))
...
- Allow Playground to work in Serverless mode ([2c0c89c](https://github.com/statsbotco/cubejs-client/commit/2c0c89c))
